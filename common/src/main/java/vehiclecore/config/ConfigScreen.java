package vehiclecore.config;

import vehiclecore.Main;
import vehiclecore.config.configEntries.BooleanConfigEntry;
import vehiclecore.config.configEntries.FloatConfigEntry;
import vehiclecore.config.configEntries.IntegerConfigEntry;
