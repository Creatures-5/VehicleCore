package vehiclecore.fabric;

import vehiclecore.ClientMain;
import vehiclecore.ItemColors;
import vehiclecore.Renderer;
import vehiclecore.WeaponRendererRegistry;
...
public final class ClientFabric implements ClientModInitializer {
    ...
    private void itemTooltipCallback(ItemStack stack, TooltipFlag context, List<Component> tooltip) {
        ...
        if (upgrade != null) {
            tooltip.add(Component.translatable("item.vehiclecore.item.upgrade").withStyle(ChatFormatting.GRAY));
