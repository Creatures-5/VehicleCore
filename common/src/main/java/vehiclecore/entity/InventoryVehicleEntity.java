...
import vehiclecore.WeaponRegistry;
...
import vehiclecore.entity.inventory.SparseSimpleInventory;
import vehiclecore.entity.inventory.VehicleInventoryDescription;
import vehiclecore.entity.inventory.slots.SlotDescription;
import vehiclecore.entity.misc.VehicleProperties;
import vehiclecore.entity.misc.WeaponMount;
import vehiclecore.entity.weapon.Telescope;
import vehiclecore.entity.weapon.Weapon;
import vehiclecore.item.WeaponItem;
import vehiclecore.item.upgrade.VehicleStat;
import vehiclecore.item.upgrade.VehicleUpgrade;
import vehiclecore.item.upgrade.VehicleUpgradeRegistry;
import vehiclecore.mixin.ServerPlayerEntityMixin;
import vehiclecore.network.s2c.OpenGuiRequest;
import vehiclecore.screen.VehicleScreenHandler;
